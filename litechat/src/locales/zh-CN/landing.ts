const landing = {
  ...
  hero: {
    ...
    titleLead: 'AI 助手',
    titleHighlight: '智慧指导',
    description: 'LiteChat 把官网、聊天入口、嵌入式插件和后台配置串成一个可复用前端基座。你可以用它快速搭出自己的 AI 助手站点，也可以继续扩展成面向真实业务的交付方案。',
    primary: '启动 LiteChat',
    secondary: '查看 GitHub',
    ...
    highlights: [
      '普通聊天与深度搜索共存',
      '截图、联网搜索、语音输入可直接接入',
      '支持继续往多 Agent 与业务流程扩展',
    ],
  },
  capabilities: {
    eyebrow: 'Capabilities',
    title: '围绕真实助手场景，而不是只做一个展示页。',
    description: '官网、聊天入口、嵌入式交付和后台配置统一在一条产品链路里，让前端不再为每个项目重复搭一次。',
    cards: [
      {
        title: '普通聊天与深度搜索切换',
        description: '在同一个入口里处理轻量问答与更复杂的搜索式推理。',
      },
      {
        title: '深度搜索聊天',
        description: '面向复杂问题的多步检索、资料归纳与上下文推理。',
      },
      {
        title: '截图理解',
      ...
      {
        title: '语音输入',
        description: '支持语音转文字，降低输入成本，更适合碎片化记录与询问。',
      },
      {
        title: '多 Agent 协作扩展',
  ...
  workflow: {
    ...
    description: 'LiteChat 不只是一层聊天 UI，而是把模型调用、后台配置、页面交付和嵌入式接入组织成更稳定的前端基础层。',
    panels: [
      {
        title: 'Eino 编排引擎',
  ...
  projectLab: {
    ...
    description: '这里会持续放入小项目实战案例，用真实场景证明 LiteChat 适合做可交付、可复用、可迭代的 AI 助手产品。',
    featured: {
      tag: '家庭可定制菜谱',
      title: '今晚吃什么，直接问 AI。',
      description: '把家庭成员口味、冰箱食材、人数、时间和忌口交给 AI，随时生成一份更贴近家里真实情况的做饭建议。',
      bullets: [
        '家庭成员口味可定制',
        '随时问 AI 今天怎么做',
  ...
  footer: {
    description: '面向 AI 助手产品的开源官网与前端交付方案，围绕 Go、Eino 与 Vben 持续演进。',
    ecosystem: '产品',
    resources: '资源',
    status: '状态',
    statusLabel: '当前状态',
