...
<template>
  ...
  >
    ...
    <button
      ...
      class="fixed bottom-36 right-8 p-2 bg-white dark:bg-gray-800 rounded-full shadow-lg border border-gray-200 dark:border-gray-700 text-gray-500 hover:text-primary hover:border-primary transition-all duration-300 z-10 animate-fade-in"
      title="回到底部"
    >
