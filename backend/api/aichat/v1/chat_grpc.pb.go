...
const (
	ChatService_SendMessage_FullMethodName    = "/aichat.chat.v1.ChatService/SendMessage"
	ChatService_GetChatHistory_FullMethodName = "/aichat.chat.v1.ChatService/GetChatHistory"
)
...
func (c *chatServiceClient) GetChatHistory(ctx context.Context, in *GetChatHistoryRequest, opts ...grpc.CallOption) (*GetChatHistoryReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedChatServiceServer) GetChatHistory(context.Context, *GetChatHistoryRequest) (*GetChatHistoryReply, error) {
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aichat.chat.v1.ChatService",
