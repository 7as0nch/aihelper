...
const (
	...
	Chat_CreateMessage_FullMethodName     = "/chat.v1.Chat/CreateMessage"
...
type ChatClient interface {
	...
	CreateSession(ctx context.Context, in *CreateSessionRequest, opts ...grpc.CallOption) (*HistorySession, error)
...
func (c *chatClient) CreateSession(ctx context.Context, in *CreateSessionRequest, opts ...grpc.CallOption) (*HistorySession, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HistorySession)
...
func (c *chatClient) CreateMessage(ctx context.Context, in *CreateMessageRequest, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
...
func (UnimplementedChatServer) HistoryById(context.Context, *HistoryRequest) (*MessagesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method HistoryById not implemented")
}
func (UnimplementedChatServer) HistoryRenameById(context.Context, *HistoryRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method HistoryRenameById not implemented")
}
func (UnimplementedChatServer) HistoryDeleteById(context.Context, *HistoryRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method HistoryDeleteById not implemented")
}
func (UnimplementedChatServer) CreateSession(context.Context, *CreateSessionRequest) (*HistorySession, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateSession not implemented")
}
func (UnimplementedChatServer) CreateMessage(context.Context, *CreateMessageRequest) (*Message, error) {
