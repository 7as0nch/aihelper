...
func wireApp(confServer *conf.Server, bootstrap *conf.Bootstrap, logger *zap.Logger, logLogger log.Logger) (*kratos.App, func(), error) {
	...
	dictTypeUseCase := base.NewDictTypeUseCase(dictTypeRepo)
	...
	httpServer := server.NewHTTPServer(confServer, userFeedbackService, chatService, authService, authRepo, systemService, trackerService, logLogger)
