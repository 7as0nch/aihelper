...
var (
	treeToolInfo = &schema.ToolInfo{
		Name: "tree",
		Desc: "This tool is used to view the directory tree structure; inspecially local Path is './'; the parameter is the path to be viewed, and it returns the complete directory tree structure under that path.",
